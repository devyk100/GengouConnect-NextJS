...
-- AddForeignKey
ALTER TABLE "FlashcardDeckToEditors" ADD CONSTRAINT "FlashcardDeckToEditors_deck_id_fkey" FOREIGN KEY ("deck_id") REFERENCES "FlashcardDeck"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "FlashcardDeckToEditors" ADD CONSTRAINT "FlashcardDeckToEditors_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "User"("user_id") ON DELETE RESTRICT ON UPDATE CASCADE;
